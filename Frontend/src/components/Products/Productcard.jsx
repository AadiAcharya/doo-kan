...
const Productcard = (props) => {
  ...
  return (
    <div className="w-[200px] md:w-[280px] border border-gray-200 mt-10 relative group ">
      {/* Image */}
      <div>
        <img
      ...
      <div className="absolute top-40 left-0 w-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex">
        <button
          type="button"
          onClick={addToCart}
          className="bg-black opacity-50 text-white p-4 w-full text-center"
        >
          <div><NavLink className='w-full px-20 py-11' to='/cart'>Add To Cart</NavLink></div>
        </button>
      </div>
