...
const Navbar = ({ scrollToSection, cartCount }) => {
      ...
      <div className='md:w-6xl xl:w-7xl max-w-7xl w-full'>
        <div className='hidden md:flex justify-between py-5 items-center'>
          ...
          <div className='flex gap-5 items-center'>
            ...
            {/* Cart & User Icons */}
            <NavLink to="/cart" aria-label="Go to Cart" className="items-center flex flex-col relative">
              <img 
              ...
              />
              {cartCount > 0 && (
                <div className='w-5 h-5 bg-red-500 text-white text-xs font-bold flex items-center justify-center absolute top-[-8px] right-[-8px] rounded-full'>
                  {cartCount}
                </div>
              )}
            </NavLink>
